                ...
                <div className="overflow-x-auto rounded-2xl border border-border/60 bg-surface/40">
                  <table className="w-full text-left text-xs sm:text-sm">
                    ...
                    <tbody className="divide-y divide-border/40 text-textMuted font-mono">
                      ...
                      <tr className="hover:bg-surfaceHighlight/30"><td className="py-2.5 px-4">57 - 60</td><td className="py-2.5 px-4 font-bold text-textMain">1.8</td><td className="py-2.5 px-4">C-</td><td className="py-2.5 px-4 text-orange-500">Below Average</td></tr>
                      <tr className="hover:bg-surfaceHighlight/30"><td className="py-2.5 px-4">50 - 56</td><td className="py-2.5 px-4 font-bold text-textMain">1.0 - 1.4</td><td className="py-2.5 px-4">D+, D</td><td className="py-2.5 px-4 text-orange-500">Pass (Minimum)</td></tr>
