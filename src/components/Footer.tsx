...
export const Footer = () => (
  <footer className="w-full border-t border-border mt-16 py-8 bg-surface/90 backdrop-blur-md relative overflow-hidden">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div className="flex flex-col items-center md:items-start opacity-70 hover:opacity-100 transition-opacity">
        ...
        <div className="text-xs text-textMuted mt-1 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
          <a 
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="hover:text-textMain transition-colors flex items-center gap-1 opacity-70 hover:opacity-100"
          >
            <Code size={12} /> Source
          </a>
        </div>
        ...
        <div className="flex gap-3">
          {[
            ...
            <motion.div 
              ...
              className="w-8 h-8 rounded-lg bg-surface/70 border border-border flex items-center justify-center text-textMuted hover:text-textMain hover:border-brand-500/30 transition-all group relative cursor-pointer"
            >
              <Tech.icon size={14} />
