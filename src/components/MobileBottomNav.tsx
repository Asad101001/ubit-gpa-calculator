  ...
  return (
    ...
    >
      <div className="flex items-center justify-around px-3 py-1.5 h-16 max-w-md mx-auto gap-2">
        ...
        >
          <div className={`p-1 rounded-md transition-colors ${isHomeActive ? 'bg-black text-yellow-400 shadow-[1.5px_1.5px_0px_0px_#000]' : ''}`}>
        ...
        >
          {isCalcActive && (
            <div className="absolute -top-1 left-3 right-3 h-1 bg-red-500 rounded-full" />
          )}
          <div className={`p-1 rounded-md ${isCalcActive ? 'text-yellow-400' : ''}`}>
            <Calculator size={20} strokeWidth={2.5} />
          </div>
          <span className={`text-[10px] uppercase tracking-tight mt-0.5 leading-none ${isCalcActive ? 'font-black text-yellow-400' : 'font-bold'}`}>
            Calculator
          </span>
        </button>
        ...
        >
          ...
          <span className={`text-[10px] uppercase tracking-tight mt-0.5 leading-none ${isResultsActive ? 'font-black text-yellow-400' : 'font-bold'}`}>
            Results
          </span>
        </button>
        ...
        {user && profile && (
          ...
          >
            <div className={`p-1 rounded-md transition-colors ${isProfileActive ? 'bg-black text-yellow-400 shadow-[1.5px_1.5px_0px_0px_#000]' : ''}`}>
